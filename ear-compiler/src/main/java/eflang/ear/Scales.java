...
public class Scales {
    ...
    public static Scale FMajor = new Scale(
            "f3", "g3", "a3", "bb3", "c4", "d4", "e4",
            "f4", "g4", "a4", "bb4", "c5", "d5", "e5",
            "f5", "g5", "a5", "bb5", "c6", "d6", "e6"
    );

    public static Scale GMajor = new Scale(
            "g3", "a3", "b3", "c4", "d4", "e4", "f#4",
            "g4", "a4", "b4", "c5", "d5", "e5", "f#5",
            "g5", "a5", "b5", "c6", "d6", "e6", "f#6"
    );

    public static Scale BluesMajor = new Scale(
            "c3", "d3", "eb3", "e3", "g3", "a3",
            "c4", "d4", "eb4", "e4", "g4", "a4",
            "c5", "d5", "eb5", "e5", "g5", "a5"
    );

    public static Scale BluesMinor = new Scale(
